      ...
      <div class="row">
        ...
        <div class="col-md-8 mt-1">
          <form action="">
            ...
            <b><label for="#">Father's Name :</label></b>
              <input id="fn" type="text" placeholder="Enter your father's name" name="frname" required><br><br>
            <b><label for="#">Mother's Name :</label></b>
              <input id="fn" type="text" placeholder="Enter your mother's name" name="mrname" required><br><br>
            <b><label for="#">Date of Birth:</label></b>
              <input id="fn" type="date" placeholder="Enter your DOB" name="dob" required><br><br>
            <b><label for="#">Gender:</label></b>
              <input id="fn" type="radio" placeholder="" name="gender" required>
              <label for="#">Male</label>
              <input id="fn" type="radio" placeholder="" name="gender" required>
              <label for="#">Female</label>
            <br><br>
            <b><label for="#">Contact No :</label></b>
              <input id="fn" type="tel" placeholder="Enter your contact no" name="cnct" required><br><br>
            <b><label for="#">Email :</label></b>
              <input id="fn" type="email" placeholder="Enter your email" name="email" required><br><br>
            <b><label for="#">Address :</label></b>
              <input id="fn" type="text" placeholder="Enter your address" name="address" required><br><br>
            <button class="btn btn-outline-secondary btn-sm">Save</button><br><br>
          </form>
        </div>

        <div class="im col-4">
          <img src="photos/gggg.jpg" alt="">
        </div>
      </div>
    </div>
